...
def main():
    ...
    parser.add_argument("--pretrain_data_path", type=str,
                        default=data_root + "/hybrid_data_train/15min/15min_lseq_total_FUT_filtered.txt")
    parser.add_argument("--checkpoint_save_path", type=str,
                        default=data_root + "/checkpoint_kbar_bin13_SIM-CLS_H15_total-lseq-contract")
    parser.add_argument("--save_path", type=str, default=data_root + "/H15_total_lseq-gpt-base-kbar-bin13-SIM-CLS-contract")
    # token
