...
def main():
    data_root = "/INPUT/lwb/k-emebedding/STOCK/"
    parser = ArgumentParser()

    parser.add_argument("--pretrain_data_path", type=str,
                        default=data_root + "daily/daily/preprocessed_data/D.txt")
    parser.add_argument("--pretrain_model_path", type=str, default=data_root + "/ckpt/===")
    parser.add_argument("--data_caches", type=str, default=data_root + "/caches_bin9_D")
    ...
    print("sentence size:", len(dataset.examples))
