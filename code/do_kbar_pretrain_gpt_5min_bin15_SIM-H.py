...
from gpt2_models import GPT2LMSIMHeadModel
...
def main():
    ...
    parser.add_argument("--pretrain_data_path", type=str,
                        default=data_root + "/hybrid_data_train/5min/5_data.txt")
    parser.add_argument("--pretrain_cls_labels_path", type=str,
                        default=data_root + "/gpt2_tokenizer_bin15_H5/cls_labels.json")
    parser.add_argument("--pretrain_token_vecs_dict_path", type=str,
                        default=data_root + "/gpt2_tokenizer_bin15_H5/token_vecs_dict.json")
    parser.add_argument("--pretrain_model_path", type=str, default=data_root + "/ckpt/===")
    parser.add_argument("--data_caches", type=str, default=data_root + "/caches_bin15_H5_sim")
    parser.add_argument("--config_path", type=str,
                        default=data_root + "/gpt_vocab_bin15_H5/config.json")
    parser.add_argument("--tokenizer_path", type=str,
                        default=data_root + "/gpt2_tokenizer_bin15_H5")
    parser.add_argument("--checkpoint_save_path", type=str,
                        default=data_root + "/checkpoint_kbar_bin15_SIM_H-5")
    parser.add_argument("--save_path", type=str, default=data_root + "/H-5-gpt-base-kbar-bin15-SIM")
