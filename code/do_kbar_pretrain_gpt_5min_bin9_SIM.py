...
def main():
    ...
    parser.add_argument("--data_caches", type=str, default=data_root + "/caches_bin9_5min_sim")
    ...
    parser.add_argument("--checkpoint_save_path", type=str,
                        default=data_root + "/checkpoint_kbar_bin9_5min_SIM")
    parser.add_argument("--save_path", type=str, default=data_root + "/5min-gpt-base-kbar-bin9-SIM")
